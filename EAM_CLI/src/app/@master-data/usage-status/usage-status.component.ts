...
@Component({
  ...
  styleUrl: './usage-status.component.scss',
})
export class UsageStatusComponent implements OnInit, OnDestroy {
  ...
  exportExcel() {
    return this._service
      ...
      .subscribe((result: Blob) => {
        ...
        anchor.download = 'danh-sach-trang-thai-su-dung.xlsx'
        anchor.href = url
        anchor.click()
      })
  }
  ...
  isCodeExist(code: string): boolean {
    return this.paginationResult.data?.some(
      (usageStatus: any) => usageStatus.code === code
    );
  }
