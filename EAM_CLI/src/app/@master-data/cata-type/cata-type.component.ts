...
@Component({
  selector: 'app-cata-type',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './cata-type.component.html',
  styleUrl: './cata-type.component.scss',
})
export class CataTypeComponent implements OnInit, OnDestroy {
  ...
  isCodeExist(code: string): boolean {
    return this.paginationResult.data?.some(
      (cataType: any) => cataType.code === code
    );
  }
