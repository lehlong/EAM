...
import { MTypeService } from '../../service/warehouse/mtype.service';
...
@Component({
  selector: 'app-mtype',
  imports: [ShareModule],
  templateUrl: './mtype.component.html',
  styleUrl: './mtype.component.scss'
})
export class MtypeComponent {
