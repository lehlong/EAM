...
import { MtgrpService } from '../../service/warehouse/mtgrp.service';
...
@Component({
  selector: 'app-mtgrp',
  imports: [ShareModule],
  templateUrl: './mtgrp.component.html',
  styleUrl: './mtgrp.component.scss'
})
export class MtgrpComponent {
  ...
  exportExcel() {
    return this._service
      ...
      .subscribe((result: Blob) => {
        ...
        anchor.download = 'danh-sach-loai-vat-tu.xlsx'
        anchor.href = url
        anchor.click()
      })
  }
